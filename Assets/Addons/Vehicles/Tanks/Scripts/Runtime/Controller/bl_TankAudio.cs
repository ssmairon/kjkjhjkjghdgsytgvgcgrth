...
{
    public class bl_TankAudio : MonoBehaviour
    {
        ...
        private bl_TankController m_CarController; // Reference to car we are controlling
        ...
        private void StartSound()
        {
            ...
            m_CarController = GetComponent<bl_TankController>();
        ...
        private void ControlSound()
        {
            if (m_StartedSound)
            {
                ...
                {
                    float p = Mathf.Abs(m_CarController.CurrentMovingSpeed) / m_CarController.topSpeed;
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_CarController.CurrentAcceleration);
